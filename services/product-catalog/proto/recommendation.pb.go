...
const file_proto_recommendation_proto_rawDesc = "" +
	...
	"\x12GetRecommendations\x12).recommendation.GetRecommendationsRequest\x1a*.recommendation.GetRecommendationsResponseB:Z8github.com/coroot/rca-lab/services/product-catalog/protob\x06proto3"
