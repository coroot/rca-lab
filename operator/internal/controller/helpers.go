...
func validateSpec(spec *v1alpha1.FailureScenarioSpec) error {
	...
	for i := range spec.Actions {
		...
		case v1alpha1.ActionTypeWorkload:
			if a.Workload == nil || a.Scale != nil || a.DeployImage != nil || a.ChaosMesh != nil || a.DBExec != nil {
				return fmt.Errorf("action %q: type Workload requires exactly the workload field", a.Name)
			}
		case v1alpha1.ActionTypeScale:
			if a.Scale == nil || a.Workload != nil || a.DeployImage != nil || a.ChaosMesh != nil || a.DBExec != nil {
				return fmt.Errorf("action %q: type Scale requires exactly the scale field", a.Name)
			}
		case v1alpha1.ActionTypeDeployImage:
			if a.DeployImage == nil || a.Workload != nil || a.Scale != nil || a.ChaosMesh != nil || a.DBExec != nil {
		...
		case v1alpha1.ActionTypeChaosMesh:
			if a.ChaosMesh == nil || a.Workload != nil || a.Scale != nil || a.DeployImage != nil || a.DBExec != nil {
				return fmt.Errorf("action %q: type ChaosMesh requires exactly the chaosMesh field", a.Name)
			}
		case v1alpha1.ActionTypeDBExec:
			if a.DBExec == nil || a.Workload != nil || a.Scale != nil || a.DeployImage != nil || a.ChaosMesh != nil {
				return fmt.Errorf("action %q: type DBExec requires exactly the dbExec field", a.Name)
			}
		default:
